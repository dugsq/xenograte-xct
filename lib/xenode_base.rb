  ...
  module XenodeBase
    ...
    def initialize(opts)
      begin
        ...
        @config      = apply_sys_token(opts[:config])
    ...
    # deprecated by apply_sys_token
    # def resolve_sys_dir(fp)
    #   if fp
    #     do_debug("@disk_dir: #{@disk_dir.inspect} @tmp_dir: #{@tmp_dir}")
    #     fp.gsub!("@disk_dir", @disk_dir) if fp.include?("@disk_dir") && @disk_dir
    #     fp.gsub!("@tmp_dir", @tmp_dir) if fp.include?("@tmp_dir") && @tmp_dir
    #   end
    #   fp
    # end
